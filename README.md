...
- [Lune Research](https://github.com/RetrogradeLabs/lune-mcp-server) - MCP server and CLI grounding coding agents (Claude Code, Codex, Cursor) in full-text peer-reviewed papers from top venues (NeurIPS, ICLR, ACL, CVPR, USENIX Security, IEEE S&P); bidirectional citation trails, claim verification returning verbatim quotes, and vetted research methodology guidance, exposed as 12 tools and 6 prompts over Streamable HTTP or stdio (MIT License, 2026)
