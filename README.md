...
- [ResearchClawBench (InternScience, arXiv 2026)](https://github.com/InternScience/ResearchClawBench)
- [REFUTE (BGPT, 2026)](https://huggingface.co/datasets/BGPT-OFFICIAL/refute) - Open benchmark for scientific epistemics on recent paper summaries: falsification, overclaim detection, missing-evidence abstention, planted-flaw detection, and Brier-scored calibration; judge-free MCQ axes + generative critique splits with [public leaderboard](https://huggingface.co/spaces/BGPT-OFFICIAL/refute-leaderboard) - Benchmark evaluating AI agents for end-to-end automated research from re-discovery to new-discovery, with 40 real-science tasks across 10 disciplines, curated datasets from published papers, and expert-curated multimodal rubrics (170+ stars, MIT License)
